...
public class databasedoctruyen extends SQLiteOpenHelper {
    ...
    //Biến lưu câu lệnh tạo bảng chuyển
    ...
    private String SQLQuery3 = "INSERT INTO TaiKhoan VAlUES (null,'hao','hao','hao@gmail.com',1)";
    ...
    public Cursor getData1(){
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor res = db.rawQuery("SELECT * FROM " + TABLE_TRUYEN + " ORDER BY " + ID_TRUYEN + " DESC LIMIT 6", null);
        return  res;
    }
